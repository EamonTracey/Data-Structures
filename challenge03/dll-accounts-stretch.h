/* Title: dll-accounts-stretch.h
 * Abstract: This header file declares structs and function prototypes for dll-accounts-stretch.c
 * Author: Eamon Tracey
...
/*
 * Below are stretch functions that merit extra credit.
 */
void displayOdd(dllist *);
void reverseList(dllist *);
void moveFirstToLast(dllist *);